...
export default function DriftWall({ items = [], onItemClick }) {
  ...
  return (
    <div className="relative w-full overflow-hidden py-4 space-y-6 [perspective:1200px]">
      ...
      {/* Row 1: Drifts to the left continuously WITHOUT hover pause */}
      <div className="flex w-max animate-drift-left gap-4 sm:gap-6 will-change-transform">
      ...
      {/* Row 2: Drifts to the right continuously WITHOUT hover pause */}
      <div className="flex w-max animate-drift-right gap-4 sm:gap-6 will-change-transform">
