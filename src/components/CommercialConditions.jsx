  ...
  return (
    <section id="condiciones" className="py-16 sm:py-20 2xl:py-28 bg-background border-b border-border relative">
      <div className="max-w-7xl 2xl:max-w-[1720px] 3xl:max-w-[1800px] mx-auto px-4 sm:px-6 2xl:px-12">
        ...
        {/* Section Header with Apple Headline */}
        <div className="text-center max-w-3xl 2xl:max-w-4xl mx-auto space-y-4 mb-12 2xl:mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl 2xl:text-6xl uppercase tracking-tight apple-headline">
            <span className="font-sf-light-italic text-muted-foreground mr-2">CONDICIONES</span>
            <span className="font-sf-bold text-foreground">COMERCIALES</span>
          </h2>

          <p className="font-sf-medium text-muted-foreground text-base sm:text-lg 2xl:text-xl apple-subheadline">
            En <span className="font-bold text-foreground">SkyBlue Calzado Mayorista</span> establecemos reglas comerciales claras: venta por módulos surtidos de fábrica, precios netos protegidos y logística bonificada.
          </p>
        </div>
          ...
          {conditions.map((item, idx) => {
            ...
            return (
              <SpotlightCard
                ...
                className="p-6 sm:p-7 bg-card hover:bg-card/90 border border-border hover:border-primary/40 hover:shadow-xl flex flex-col justify-between rounded-3xl"
              >
                <div>
                  ...
                  <h3 className="text-lg font-sf-bold text-foreground mb-2.5">
                    {item.title}
                  </h3>

                  <p className="text-xs sm:text-sm font-sf-regular text-muted-foreground leading-relaxed mb-4">
                    {item.description}
                  </p>
                </div>

                <div className="pt-4 border-t border-border flex items-center gap-2 text-xs font-sf-medium text-foreground">
        ...
        <div className="mt-10 p-6 sm:p-8 rounded-3xl bg-card border border-border shadow-md">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-border">
            <div className="space-y-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-sf-bold uppercase tracking-wider">
                <Layers className="w-3.5 h-3.5" />
                <span>Curvas Surtidas Directo de Fábrica</span>
              </div>
              <h3 className="text-xl sm:text-2xl font-sf-bold text-foreground">
                Composición Estándar de Módulos (Calzado Dama 35 al 40)
              </h3>
              <p className="text-xs sm:text-sm text-muted-foreground font-sf-regular">
            ...
            <div className="shrink-0 flex items-center gap-3">
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-primary/10 hover:bg-primary text-primary hover:text-primary-foreground font-sf-bold text-xs border border-primary/20 hover:border-primary transition-all flex items-center gap-2 shadow-xs"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
            ...
            <div className="p-5 rounded-2xl bg-secondary/50 border border-border/80 space-y-3">
              <div className="flex items-center justify-between">
                <span className="font-sf-bold text-sm text-foreground uppercase tracking-wide">
                  Curva 8 Pares (Módulo Clásico)
                </span>
                <span className="text-xs font-sf-bold text-primary px-2.5 py-0.5 rounded-full bg-primary/10">
                  Total: 8 Pares
                </span>
              </div>
              ...
              <div className="grid grid-cols-5 gap-2 text-center">
                <div className="p-2.5 rounded-xl bg-card border border-border">
                  <div className="text-xs text-muted-foreground font-sf-medium">T. 36</div>
                  <div className="text-base font-sf-bold text-foreground">1 par</div>
                </div>
                <div className="p-2.5 rounded-xl bg-primary/10 border border-primary/30 ring-2 ring-primary/20">
                  <div className="text-xs text-primary font-sf-bold">T. 37</div>
                  <div className="text-base font-sf-bold text-primary">2 pares</div>
                </div>
                <div className="p-2.5 rounded-xl bg-primary/10 border border-primary/30 ring-2 ring-primary/20">
                  <div className="text-xs text-primary font-sf-bold">T. 38</div>
                  <div className="text-base font-sf-bold text-primary">2 pares</div>
                </div>
                <div className="p-2.5 rounded-xl bg-primary/10 border border-primary/30 ring-2 ring-primary/20">
                  <div className="text-xs text-primary font-sf-bold">T. 39</div>
                  <div className="text-base font-sf-bold text-primary">2 pares</div>
                </div>
                <div className="p-2.5 rounded-xl bg-card border border-border">
                  <div className="text-xs text-muted-foreground font-sf-medium">T. 40</div>
                  <div className="text-base font-sf-bold text-foreground">1 par</div>
                </div>
              </div>
              <p className="text-[11px] text-muted-foreground italic font-sf-regular">
            ...
            <div className="p-5 rounded-2xl bg-secondary/50 border border-border/80 space-y-3">
              ...
              <div className="grid grid-cols-6 gap-1.5 sm:gap-2 text-center">
                <div className="p-2 rounded-xl bg-card border border-border">
                  <div className="text-[11px] text-muted-foreground font-sf-medium">T. 35</div>
                  <div className="text-sm font-sf-bold text-foreground">1 par</div>
                </div>
                <div className="p-2 rounded-xl bg-card border border-border">
                  <div className="text-[11px] text-muted-foreground font-sf-medium">T. 36</div>
                  <div className="text-sm font-sf-bold text-foreground">2 pares</div>
                </div>
                <div className="p-2 rounded-xl bg-primary/10 border border-primary/30 ring-2 ring-primary/20">
                  <div className="text-[11px] text-primary font-sf-bold">T. 37</div>
                  <div className="text-sm font-sf-bold text-primary">3 pares</div>
                </div>
                <div className="p-2 rounded-xl bg-primary/10 border border-primary/30 ring-2 ring-primary/20">
                  <div className="text-[11px] text-primary font-sf-bold">T. 38</div>
                  <div className="text-sm font-sf-bold text-primary">3 pares</div>
                </div>
                <div className="p-2 rounded-xl bg-primary/10 border border-primary/30 ring-2 ring-primary/20">
                  <div className="text-[11px] text-primary font-sf-bold">T. 39</div>
                  <div className="text-sm font-sf-bold text-primary">2 pares</div>
                </div>
                <div className="p-2 rounded-xl bg-card border border-border">
                  <div className="text-[11px] text-muted-foreground font-sf-medium">T. 40</div>
                  <div className="text-sm font-sf-bold text-foreground">1 par</div>
                </div>
              </div>
              <p className="text-[11px] text-muted-foreground italic font-sf-regular">
        ...
        <div className="mt-10 p-6 sm:p-8 rounded-3xl bg-foreground text-background shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-6 border border-border">
          <div className="space-y-2 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-amber-400 text-slate-950 text-xs font-sf-bold uppercase tracking-wider">
              <Lock className="w-3.5 h-3.5" />
              <span>Plataforma Exclusiva para Comerciantes</span>
            </div>
            <h4 className="text-xl sm:text-2xl font-sf-bold text-background">
              ¿Buscás ver listas de precios netos y stock en tiempo real?
            </h4>
            <p className="text-muted text-sm max-w-2xl font-sf-regular">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 shrink-0">
            <a
              ...
              className="px-6 py-3.5 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-sf-bold text-sm shadow-lg hover:scale-105 transition-all flex items-center gap-2"
            >
            ...
            <button
              ...
              className="px-5 py-3.5 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-sf-bold text-sm shadow-sm transition-all"
            >
      ...
      {showSizeGuideModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-card text-card-foreground rounded-3xl max-w-3xl w-full max-h-[92vh] overflow-y-auto p-6 sm:p-8 space-y-5 border border-border shadow-2xl relative">
            ...
            <div className="space-y-1">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-sf-bold uppercase">
                <Ruler className="w-3.5 h-3.5" />
                <span>Tabla de Medidas Oficial SkyBlue</span>
              </div>
              <h3 className="text-2xl font-sf-bold text-foreground">
            ...
            {/* Imagen oficial de la Guía de Talles */}
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-3 border-t border-border">
              <div className="text-xs text-muted-foreground text-center sm:text-left font-sf-regular">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => setShowSizeGuideModal(false)}
                  className="px-5 py-2.5 rounded-xl bg-foreground text-background text-xs font-sf-bold hover:bg-foreground/90 transition-all"
                >
                  Cerrar
                </button>
              </div>
