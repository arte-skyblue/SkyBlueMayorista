...
export default function BenefitsSection({ onOpenModal, onOpenAdvisorModal }) {
  ...
  return (
    <section id="beneficios" className="py-16 sm:py-24 2xl:py-28 bg-neutral-950 text-white border-b border-neutral-800">
      <div className="max-w-7xl 2xl:max-w-[1720px] 3xl:max-w-[1800px] mx-auto px-4 sm:px-6 2xl:px-12">
        ...
        <div className="text-center max-w-3xl 2xl:max-w-4xl mx-auto space-y-4 mb-14 2xl:mb-18">
          <h2 className="text-3xl sm:text-5xl 2xl:text-6xl uppercase tracking-tight apple-headline">
            <span className="font-sf-light-italic text-neutral-400 mr-2">BENEFICIOS</span>
            <span className="font-sf-bold text-white">EXCLUSIVOS</span>
          </h2>
            ...
            return (
              <SpotlightCard
                ...
                className={`p-6 sm:p-7 rounded-3xl flex flex-col justify-between relative transition-all duration-300 group overflow-hidden ${
                  isFeatured
                    ? 'bg-neutral-900 border-2 border-primary/50 shadow-2xl shadow-primary/10'
                    : 'bg-neutral-900/80 hover:bg-neutral-900 border border-neutral-800 hover:border-primary/40 hover:shadow-xl'
                }`}
              >
                <div>
                  <div className="flex items-center gap-3.5 mb-4">
                    ...
                    <div>
                      ...
                      <h3 className="text-base sm:text-lg font-sf-bold text-white group-hover:text-primary transition-colors leading-snug">
                        {item.title}
                      </h3>
                    </div>
                  </div>

                  <p className="text-xs sm:text-sm font-sf-regular text-neutral-300 leading-relaxed">
                    {item.description}
                  </p>
                </div>

                <div className="pt-4 mt-4 border-t border-neutral-800 flex items-center gap-2 text-xs font-sf-medium text-white">
